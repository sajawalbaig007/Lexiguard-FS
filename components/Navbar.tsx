...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-4 w-full z-50 px-4 md:px-20">
      <div className="max-w-7xl mx-auto bg-white dark:bg-gray-900 border dark:border-gray-700 shadow-md rounded-2xl px-6 h-16 md:h-20 flex items-center justify-between">
      ...
      {/* Mobile Menu */}
      {mobileMenu && (
        <div className="md:hidden mt-3 bg-white dark:bg-gray-800 rounded-2xl shadow-lg border dark:border-gray-700 p-6 space-y-4">
