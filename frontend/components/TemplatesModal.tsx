...
<>
{/* ================= MAIN MODAL ================= */}
{!showBuilder && ( <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-[9999]"> <div className="bg-white w-[80vw] h-[90vh] rounded-xl shadow-lg flex relative text-gray-900">
...
```
        ...
        {/* Sidebar */}
        <div className="w-[260px] border-r border-gray-300 p-4">
          <input
          ...
          <div className="grid grid-cols-2 gap-6">
            {filteredTemplates.map((item, i) => (
              <div
                ...
                className="group flex items-start gap-4 p-4 border border-gray-300 rounded-xl bg-[#F9FAFB] hover:bg-white hover:shadow-md hover:-translate-y-[2px] transition-all duration-200 cursor-pointer"
              >
                <div className="w-[100px] h-12 flex items-center justify-center rounded-lg bg-[#B5A491]/20 text-2xl group-hover:scale-110 transition">
                  {item.emoji}
                </div>
                <div>
